...
if (isset($_POST['tutto']) or ($_POST['search']))
{
	foreach ($connessione->query($x) as $row){
		?><table border="1"><?php
	...
	foreach($connessione->query($z) as $row){
	...
	foreach ($connessione->query($w) as $row){
